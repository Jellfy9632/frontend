...
console.log("배열 정렬 " + array2.sort((a, b) => a - b));
console.log("배열 정렬 " + array2.sort((a, b) => b - a));
console.log("배열 역순 출력 " + fruits.reverse());
console.log("배열 망고의 index 찾기 " + fruits.indexOf("망고"));
console.log("배열 망고의 포함여부 includes " + fruits.includes("망고")); // true
console.log("배열 딸기의 index 찾기 " + fruits.indexOf("딸기"));
console.log("배열 딸기의 포함여부 includes " + fruits.includes("딸기")); // false
...
// 얕은복사(주소복사) 깊은 복사 (값 복사 - 서로 다른 주소값)

let fruits2 = fruits; // 얕은복사 (동일한 주소값)

// ... : spread
let shallowCopy = [...fruits]; // 깊은복사 ()
fruits.push("딸기");
